...
if (!isLoggedIn()) {
    header('Location: ../login.php?redirect=user/profile.php');
    exit;
}
...
<style>
    ...
    .btn-secondary:hover {
        background-color: <?php echo adjustBrightness($secondaryColor, -20); ?> !important;
    }
...
<div class="main-content max-w-2xl mx-auto px-4 py-12">
        ...
        <form method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="full_name" value="<?php echo htmlspecialchars($user['full_name']); ?>"
                       ...
                       style="focus:border-color: <?php echo $primaryColor; ?>; focus:ring-color: <?php echo adjustBrightness($primaryColor, 70); ?>;"
                       required>
            </div>
            ...
            <div class="flex gap-3 pt-6">
                <button type="submit" class="flex-1 px-6 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                        style="background-color: <?php echo $primaryColor; ?>; hover:background-color: <?php echo adjustBrightness($primaryColor, -20); ?>;">
    ...
    <div class="mt-12 bg-white rounded-2xl border border-red-200 p-8">
        ...
        <div class="flex gap-3">
            <a href="change-password.php" class="px-6 py-3 border-2 transition-colors rounded-lg font-semibold"
               style="border-color: <?php echo $secondaryColor; ?>; color: <?php echo $secondaryColor; ?>; background-color: <?php echo adjustBrightness($secondaryColor, 85); ?>;">
                Change Password
            </a>
        </div>
    </div>
